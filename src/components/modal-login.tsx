    ...
    >
      ...
      <div className="flex flex-col gap-space-10">
        <div className="flex flex-col gap-space-3">
          <p className="text-start font-poppins font-[200] text-l">Enter your name</p>
          <input
            type="text"
            value={username}
        ...
        <div className="flex flex-col gap-space-3">
          <p className="text-start font-poppins font-[200] text-l">Enter password</p>
          <input
        ...
        <div className="flex flex-col gap-space-5 mt-10">
          ...
          <div className="flex flex-col gap-space-3 pt-space-2 text-center">
            <Link to="/" className="font-poppins text-s">Forget password?</Link>
            <div className="flex flex-col items-center">
              <span className="font-poppins text-s">New to Fake Bank?</span>
              <Link to="/signup" className="font-poppins text-s">Register now!</Link>
            </div>
          </div>
        </div>
      </div>
